    ...
    pl: {
      ...
      additionalList: [
        ...
        {icon: 'fas  fa-bolt', text: 'Tworzenie treści promocyjnych'}
                ...
                {
                  company: 'KULE',
                  period: 'styczeń 2025 – sierpień 2026',
          ...
          achievements: [
            ...
            'Animacja i obsługa gości na imprezach okolicznościowych'
        ...
        },
                 {
                   ...
                   location: '',
                   achievements: [
                     'Obsługa strefy gastronomicznej',
